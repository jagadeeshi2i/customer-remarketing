...
def plot_bar(column):
    ...
    plt.show()
    plt.savefig.plot_bar("job"), plot_bar("marital"), plot_bar(
        "education"
    ), plot_bar("contact"), plot_bar("loan"), plot_bar("housing")
...
def feature_engineering(data):
    ...
    data.contact = data.contact.map({"cellular": 1, "telephone": 0}).astype(
        "uint8"
    )
